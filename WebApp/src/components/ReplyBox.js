    ...
    render () {
        return (
            <div>
                ...
                <button onClick={this.sendReply} disabled={this.state.text ===""}>Answer</button>
                <input type="file" onChange={this.onAttatchImage} />
                <button onClick={this.sendImage} disabled={this.state.text ===""}>Upload_Image</button>
              </div>
